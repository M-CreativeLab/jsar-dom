...
export class GLTFBinaryExtension extends GLTFLoaderExtension {
  private _bin: BABYLON.IDataBuffer;

  public constructor() {
    super('KHR_binary_glTF');
  }

  public loadRuntimeAsync(scene: BABYLON.Scene, data: IGLTFLoaderData, rootUrl: string, onSuccess: (gltfRuntime: IGLTFRuntime) => void): boolean {
