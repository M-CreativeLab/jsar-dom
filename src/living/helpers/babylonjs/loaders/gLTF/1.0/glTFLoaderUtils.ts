...
export class GLTFUtils {
  ...
  public static SetMatrix(
    ...
    uniformName: string,
    shaderMaterial: BABYLON.ShaderMaterial | BABYLON.Effect
  ): void {
    let mat: BABYLON.Nullable<BABYLON.Matrix> = null;
   ...
   */
  public static SetUniform(shaderMaterial: BABYLON.ShaderMaterial | BABYLON.Effect, uniform: string, value: any, type: number): boolean {
    switch (type) {
   ...
   */
  public static GetDefaultMaterial(scene: BABYLON.Scene): BABYLON.ShaderMaterial {
  ...
  private static _DefaultMaterial: BABYLON.Nullable<BABYLON.ShaderMaterial> = null;
}
