...
const { Animation } = BABYLON;

function getColor3(_target: any, source: Float32Array, offset: number, scale: number): BABYLON.Color3 {
  return BABYLON.Color3.FromArray(source, offset).scale(scale);
}
...
class CameraAnimationPropertyInfo extends AnimationPropertyInfo {
  /** @internal */
  public buildAnimations(target: ICamera, name: string, fps: number, keys: any[], callback: (babylonAnimatable: BABYLON.IAnimatable, babylonAnimation: Animation) => void): void {
...
class MaterialAnimationPropertyInfo extends AnimationPropertyInfo {
  /** @internal */
  public buildAnimations(target: IMaterial, name: string, fps: number, keys: any[], callback: (babylonAnimatable: BABYLON.IAnimatable, babylonAnimation: Animation) => void): void {
...
class LightAnimationPropertyInfo extends AnimationPropertyInfo {
  ...
  public buildAnimations(
    ...
    fps: number,
    keys: any[],
    callback: (babylonAnimatable: BABYLON.IAnimatable, babylonAnimation: Animation) => void
  ): void {
