      ...
      return this._loader.loadNodeAsync(context, node, (babylonMesh) => {
        ...
        switch (light.type) {
          case KHRLightsPunctual_LightType.DIRECTIONAL: {
            const babylonDirectionalLight = new BABYLON.DirectionalLight(name, BABYLON.Vector3.Backward(), this._loader.babylonScene);
            babylonDirectionalLight.position.setAll(0);
            babylonLight = babylonDirectionalLight;
            break;
          }
          case KHRLightsPunctual_LightType.POINT: {
            babylonLight = new BABYLON.PointLight(name, BABYLON.Vector3.Zero(), this._loader.babylonScene);
            break;
          }
          case KHRLightsPunctual_LightType.SPOT: {
            const babylonSpotLight = new BABYLON.SpotLight(name, BABYLON.Vector3.Zero(), BABYLON.Vector3.Backward(), 0, 1, this._loader.babylonScene);
