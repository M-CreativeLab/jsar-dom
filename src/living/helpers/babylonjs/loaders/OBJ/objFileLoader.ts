...
type WebRequest = BABYLON.WebRequest;
...
export class OBJFileLoader implements BABYLON.ISceneLoaderPluginAsync, BABYLON.ISceneLoaderPluginFactory {
   ...
   */
  public static UV_SCALING = new BABYLON.Vector2(1, 1);
  /**
   ...
   */
  public importMeshAsync(meshesNames: any, scene: Scene, data: any, rootUrl: string): Promise<BABYLON.ISceneLoaderAsyncResult> {
