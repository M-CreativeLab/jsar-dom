...
export class WebXRManagedOutputCanvasOptions {
   ...
   */
  public static GetDefaults(engine?: BABYLON.ThinEngine): WebXRManagedOutputCanvasOptions {
...
export class WebXRManagedOutputCanvas implements BABYLON.WebXRRenderTarget {
  private _canvas: BABYLON.Nullable<HTMLCanvasElement> = null;
  ...
  private _setManagedOutputCanvas(canvas: BABYLON.Nullable<HTMLCanvasElement>) {
    this._removeCanvas();
    if (!canvas) {
      this._canvas = null;
