...
import { type WebXRLayerType, WebXRLayerWrapper } from '../LayerWrapper';
...
class WebXRCompositionLayerRenderTargetTextureProvider extends WebXRLayerRenderTargetTextureProvider {
  ...
  private _getSubImageForEye(eye: XREye): BABYLON.Nullable<XRWebGLSubImage> {
  ...
  public getRenderTargetTextureForEye(eye: XREye): BABYLON.Nullable<BABYLON.RenderTargetTexture> {
  ...
  public getRenderTargetTextureForView(view: XRView): BABYLON.Nullable<BABYLON.RenderTargetTexture> {
    return this.getRenderTargetTextureForEye(view.eye);
  }

  protected _setViewportForSubImage(viewport: BABYLON.Viewport, subImage: XRWebGLSubImage) {
  ...
  public trySetViewportForView(viewport: BABYLON.Viewport, view: XRView): boolean {
